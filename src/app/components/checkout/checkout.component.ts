...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit(){
    ...
    let orderItems : OrderItem[] = carItems.map(tempCarItem => new OrderItem(tempCarItem));
  ...
  get creditCarNameOnCard(){return this.checkoutFormGroup.get('creditCard.nameOnCard');}
  ...
  getStates(formGroupName: string){
    ...
    this.luv2ShopService.getStates(countryCode).subscribe(
      data => {
        // checking the form group to assing the value
